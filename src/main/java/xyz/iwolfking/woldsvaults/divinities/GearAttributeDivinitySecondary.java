...
// why
public class GearAttributeDivinitySecondary extends LearnableSkill implements GearAttributeSkill, TickingSkill {
    private VaultGearAttribute<?> attribute;
    private double value;

    public GearAttributeDivinitySecondary(int unlockLevel, int learnPointCost, int regretPointCost, VaultGearAttribute<?> attribute, double value) {
        super(unlockLevel, learnPointCost, regretPointCost);
        this.attribute = attribute;
        this.value = value;
    }

    public GearAttributeDivinitySecondary() {
    }
