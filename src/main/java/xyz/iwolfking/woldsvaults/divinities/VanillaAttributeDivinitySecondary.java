...
// why
public class VanillaAttributeDivinitySecondary extends LearnableSkill implements GearAttributeSkill, TickingSkill {
    ...
    public VanillaAttributeDivinitySecondary(int unlockLevel, int learnPointCost, int regretPointCost, Attribute attribute, AttributeModifier.Operation operation, double amount) {
    ...
    public VanillaAttributeDivinitySecondary() {
    }
