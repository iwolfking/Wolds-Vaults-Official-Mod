...
public class KineticReductionDivinity extends LearnableSkill {
    ...
    public static void onLivingEntityHurt(LivingHurtEvent event) {
        ...
        if (var2 instanceof Player player) {
            ...
            DivinityTree expertises = PlayerDivinityData.get(player.getServer()).getDivinityTree(player);

            for (KineticReductionDivinity power : expertises.getAll(KineticReductionDivinity.class, Skill::isUnlocked)) {
