    ...
    public void registerConfigs() {
        ...
        add("wolds_talents", builder -> {
            builder.addDescription("Potent_Elixir", description -> {
                description.add(JsonDescription.simple("Increases the "));
                description.add(JsonDescription.simple("Potency ", "#E9C375"));
                description.add(JsonDescription.simple("of your "));
                description.add(JsonDescription.simple("Vault Potion ", "aqua"));
                description.add(JsonDescription.simple(", boosting its effect."));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+2 Absorption Hearts", "gold"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+4% Cooldown Reduction", "aqua"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+1 Casted Ability Levels", "yellow"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+20 Flat Mana gained", "aqua"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+5 second effect duration", "yellow"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+1 effect level", "green"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+4 Absorption Hearts", "gold"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+8% Cooldown Reduction", "aqua"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+2 Casted Ability Levels", "yellow"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+40 Flat Mana gained", "aqua"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+10 second effect duration", "yellow"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+2 effect level", "green"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+6 Absorption Hearts", "gold"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+12% Cooldown Reduction", "aqua"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+3 Casted Ability Levels", "yellow"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+60 Flat Mana gained", "aqua"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+15 second effect duration", "yellow"));
                description.add(JsonDescription.simple(", "));
                description.add(JsonDescription.simple("+3 effect level", "green"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Potent Elixir<white> add <gold>+2 Absorption Hearts<white>, <aqua>+2% Cooldown Reduction<white>, <yellow>+1 additional casted Ability level<white> <aqua>+20 Flat Mana restored<white>, <aqua>+5% mana restored<white>, <yellow>+3 second effect duration<white>, and <green>+1 effect amplifier every 3 levels"));
            });
            builder.addDescription("Healthy_Elixir", description -> {
                description.add(JsonDescription.simple("Enhances the "));
                description.add(JsonDescription.simple("Healthiness ", "#E9C375"));
                description.add(JsonDescription.simple("of your "));
                description.add(JsonDescription.simple("Vault Potion ", "aqua"));
                description.add(JsonDescription.simple(", making it also heal an additional percentage of your "));
                description.add(JsonDescription.simple("max health", "green"));
                description.add(JsonDescription.simple(".\n\nDepending on the tier, the amount restored will be modified: "));
                description.add(JsonDescription.simple("\n<yellow>Vial<white>: <red>50% reduction"));
                description.add(JsonDescription.simple("\n<yellow>Potion<white>: <red>25% reduction"));
                description.add(JsonDescription.simple("\n<yellow>Mixture<white>: <gold>0% reduction"));
                description.add(JsonDescription.simple("\n<yellow>Brew<white>: <green>50% increase"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+20%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+30%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+40%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Healthy Elixir<white> add <green>3% additional max health restored"));
            });
            builder.addDescription("Ransack", description -> {
                description.add(JsonDescription.simple("Breaking sliceable "));
                description.add(JsonDescription.simple("Vault Chests ", "#E9C375"));
                description.add(JsonDescription.simple("becomes faster with additional "));
                description.add(JsonDescription.simple("Dismantling Chance", "purple"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+50% Dismantle Chance", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+75% Dismantle Chance", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+100% Dismantle Chance", "#E9C375"));
                description.add(JsonDescription.simple("\n\n4 "));
                description.add(JsonDescription.simple("+125% Dismantle Chance", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Ransack<white> add <purple>+25% Dismantling Chance"));
            });
            builder.addDescription("Lunge", description -> {
                description.add(JsonDescription.simple("Increases the reach in which you hit with melee weapons with additional"));
                description.add(JsonDescription.simple("Attack Range", "#E9C375"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+0.25 Attack Range", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+0.5 Attack Range", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+0.75 Attack Range", "#E9C375"));
                description.add(JsonDescription.simple("\n\n4 "));
                description.add(JsonDescription.simple("+1 Attack Range", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Lunge<white> add <yellow>+1 Attack Range"));
            });
            builder.addDescription("Medic", description -> {
                description.add(JsonDescription.simple("Improve your healing skills and sources with increased "));
                description.add(JsonDescription.simple("Healing Effectiveness", "#E9C375"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+10% Healing Effectiveness", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+20% Healing Effectiveness", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+30% Healing Effectiveness", "#E9C375"));
                description.add(JsonDescription.simple("\n\n4 "));
                description.add(JsonDescription.simple("+40% Healing Effectiveness", "#E9C375"));
                description.add(JsonDescription.simple("\n\n5 "));
                description.add(JsonDescription.simple("+50% Healing Effectiveness", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Medic<white> add <green>+10% Healing Effectiveness"));
            });
            builder.addDescription("Momentum_Engine", description -> {
                description.add(JsonDescription.simple("While moving, builds up stacks of "));
                description.add(JsonDescription.simple("Momentum ", "#E9C375"));
                description.add(JsonDescription.simple("increasing your "));
                description.add(JsonDescription.simple("Movement Speed", "yellow"));
                description.add(JsonDescription.simple(". When at the maximum stacks, the next melee strike consumes all stacks to trigger a guaranteed "));
                description.add(JsonDescription.simple("Shocking Hit "));
                description.add(JsonDescription.simple("with a modified radius and knockback. Remaining stationary or performing a melee strike will remove stacks."));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("5 max stacks, 4% Movement Speed per stack, stacking every 4 seconds. 6 Radius with 120% Knockback.", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+5 max stacks, 4% Movement Speed per stack, stacking every 3.5 seconds. 7 Radius with 140% Knockback", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("5 max stacks, 4% Movement Speed per stack, stacking every 3 seconds. 8 Radius with 160% Knockback.", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Momentum Engine<white> add <yellow>0.1 second charge reduction <white>and <yellow>increased knockback and size"));
            });
            builder.addDescription("Healthy_Harvest", description -> {
                description.add(JsonDescription.simple("Adds a chance for "));
                description.add(JsonDescription.simple("Heart Fragments ", "#E9C375"));
                description.add(JsonDescription.simple("to generate when opening "));
                description.add(JsonDescription.simple("Vault Chests", "yellow"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+4%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+6%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+12%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n4 "));
                description.add(JsonDescription.simple("+8%", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Supply Crates<white> add <red>+1% additional chance"));
            });
            builder.addDescription("Arcane_Strike", description -> {
                description.add(JsonDescription.simple("Enhances your "));
                description.add(JsonDescription.simple("Lucky Hits ", "#E9C375"));
                description.add(JsonDescription.simple("causing them to reduce all of your abilities "));
                description.add(JsonDescription.simple("cooldowns by a percentage of their maximum cooldown time"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+10% reduced cooldown", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Arcane Cascade<white> add <aqua>+2% reduced cooldown"));
            });
            builder.addDescription("Fanged_Strike", description -> {
                description.add(JsonDescription.simple("Enhances your "));
                description.add(JsonDescription.simple("Lucky Hits ", "#E9C375"));
                description.add(JsonDescription.simple("causing them to launch a Fang striking your target from below dealing a small portion of your attack's "));
                description.add(JsonDescription.simple("damage ", "red"));
                description.add(JsonDescription.simple("and procs any on-hit effects again"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+5% damage", "#E9C375"));
                description.add(JsonDescription.simple("\n\n2 "));
                description.add(JsonDescription.simple("+7.5% damage", "#E9C375"));
                description.add(JsonDescription.simple("\n\n3 "));
                description.add(JsonDescription.simple("+10% damage", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Fanged Strike<white> add <red>+1% increased damage"));
            });

            builder.addDescription("Executing_Strike", description -> {
                description.add(JsonDescription.simple("Enhances your "));
                description.add(JsonDescription.simple("Lucky Hits ", "#E9C375"));
                description.add(JsonDescription.simple("causing them to deal a portion of the target's "));
                description.add(JsonDescription.simple("missing health ", "red"));
                description.add(JsonDescription.simple("as bonus "));
                description.add(JsonDescription.simple("damage ", "red"));
                description.add(JsonDescription.simple(".\n\n1 "));
                description.add(JsonDescription.simple("+15% of missing health", "#E9C375"));
                description.add(JsonDescription.simple("\n\n"));
                description.add(JsonDescription.simple("Overlevels to <gold>Executing Strike<white> add <red>+1% increased missing health damage"));
            });
