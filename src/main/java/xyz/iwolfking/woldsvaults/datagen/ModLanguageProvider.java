...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("create.item_attributes.companion_cooldown", "is a Companion on cooldown");
        add("create.item_attributes.companion_cooldown.inverted", "isn't a Companion on cooldown");
        add("create.item_attributes.companion_hearts", "is a Companion with at least \"%1$s\" hearts");
        add("create.item_attributes.companion_hearts.inverted", "isn't a Companion with at least \"%1$s\" hearts");
        add("create.item_attributes.companion_max_hearts", "is a Companion with at least \"%1$s\" max hearts");
        add("create.item_attributes.companion_max_hearts.inverted", "isn't a Companion with at least \"%1$s\" max hearts");
        add("create.item_attributes.companion_level", "is a Companion of at least level \"%1$s\"");
        add("create.item_attributes.companion_level.inverted", "isn't a Companion of at least level \"%1$s\"");
        add("create.item_attributes.companion_series", "is a Companion of the \"%1$s\" Series");
        add("create.item_attributes.companion_series.inverted", "isn't a Companion of the \"%1$s\" Series");
        add("create.item_attributes.companion_skin_name", "is a Companion with a skin of \"%1$s\"");
        add("create.item_attributes.companion_skin_name.inverted", "isn't a Companion with a skin of \"%1$s\"");
        add("create.item_attributes.companion_temporal", "is a Companion with a \"%1$s\" temporal modifier");
        add("create.item_attributes.companion_temporal.inverted", "isn't a Companion with a \"%1$s\" temporal modifier");
        add("create.item_attributes.card_deck_has_modifier", "is a Card Deck with a modifier");
        add("create.item_attributes.card_deck_has_modifier.inverted", "isn't a Card Deck with a modifier");
        add("create.item_attributes.card_deck_empty", "is an empty Card Deck");
        add("create.item_attributes.card_deck_empty.inverted", "isn't an empty Card Deck");
        add("create.item_attributes.card_deck_type", "is a \"%1$s\"");
        add("create.item_attributes.card_deck_type.inverted", "isn't a \"%1$s\"");
