                ...
                .displayType(VaultEvent.EventDisplayType.NONE)
                        .task(new WeightedTask.Builder()
                                .task(new TaskGroup.Builder()
                                        ...
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("An elite undead arises!").withStyle(ChatFormatting.DARK_PURPLE)))
                                        .build(), 4.0)
                                ...
                                .task(new TaskGroup.Builder()
                                        ...
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("Suddenly your muscles tense up!").withStyle(ChatFormatting.DARK_RED)))
                                        .build(),10.0)
                                .task(new TaskGroup.Builder()
                                        .task(new ExplosionTask(5.0F, Explosion.BlockInteraction.BREAK, true))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("The grave was rigged to explode!").withStyle(ChatFormatting.RED)))
                                        .build(),10.0)
                                .task(new TaskGroup.Builder()
                                        .task(new VaultModifierTask(VaultMod.id("cake_haunted"), 1))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.CHAT_MESSAGE_TARGET, (TextComponent) new TextComponent("Soul Shards drop chance has gone up!").withStyle(ChatFormatting.LIGHT_PURPLE)))
                                        .task(new PlaySoundTask(SoundEvents.AMBIENT_CAVE))
                                        .build(), 10.0)
                                .task(new TaskGroup.Builder()
                                        .task(new VaultModifierTask(VaultMod.id("haunted_mansion"), 1, 1800))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("The vault is feeling a bit spookier...").withStyle(ChatFormatting.DARK_GRAY)))
                                        .task(new PlaySoundTask(SoundEvents.AMBIENT_CAVE))
                                        .build(), 2.0)
                                .task(new TaskGroup.Builder()
                                        .task(new VaultModifierTask(VaultMod.id("ethereal_mobs"), 1, 900))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("You feel a phantasmal wave flow throughout the vault.").withStyle(ChatFormatting.DARK_AQUA)))
                                        .task(new PlaySoundTask(SoundEvents.AMBIENT_CAVE))
                                        .build(), 4.0)
                                .task(new TaskGroup.Builder()
                                        .task(new SpawnMobTask.Builder()
                                ...
                                .task(new TaskGroup.Builder()
                                        ...
                                        .task(new PlaySoundTask(SoundEvents.AMBIENT_CAVE))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("A zombie is unearthed!").withStyle(ChatFormatting.DARK_GREEN)))
                                        .build(),15.0)
                                .task(new TaskGroup.Builder()
                                        .task(new SpawnMobTask.Builder()
                                        ...
                                        .task(new PlaySoundTask(SoundEvents.AMBIENT_CAVE))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("Skeletons are unearthed!").withStyle(ChatFormatting.GRAY)))
                                        .build(),20.0)
                                .task(new TaskGroup.Builder()
                                        .task(new SpawnMobTask.Builder()
                                        ...
                                        .task(new PlaySoundTask(SoundEvents.AMBIENT_CAVE))
                                        .task(new MessageTask(VaultEvent.EventDisplayType.ACTION_BAR, (TextComponent) new TextComponent("A horse is unearthed?").withStyle(ChatFormatting.LIGHT_PURPLE)))
                                        .build(),2.0)
                                .build()
