...
public class ModOptions {
    ...
    public static final VaultOption<LightmanWalletHudOptions> LIGHTMAN_WALLET = VaultOptionsRegistry.register("woldsOptions.json", WoldsVaults.id("inv_hud_lightman_wallet"), LightmanWalletHudOptions.createDefault(new HudPosition(0.8F, 0.05F)), null, LightmanWalletHudOptions.ADAPTER);
