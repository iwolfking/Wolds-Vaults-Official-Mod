...
public class ScalingScavengerBingoCrystalObjective extends CrystalObjective implements INamedObjective {
    ...
    public ScalingScavengerBingoCrystalObjective(float objectiveProbability, int sealCount) {
        this.objectiveProbability = objectiveProbability;
        this.sealCount = sealCount;
    }

    public ScalingScavengerBingoCrystalObjective() {
        this.sealCount = 1;
    }
    ...
    public String getCrystalName() {
        return getHeight() + "x" + getWidth() + " Collector Crystal";
    }
