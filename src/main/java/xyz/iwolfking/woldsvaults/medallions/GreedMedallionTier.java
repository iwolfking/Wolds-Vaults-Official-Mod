 ...
 * every other source per the design doc.</p>
 */
public enum GreedMedallionTier {
    SCAVENGER_1("scavenger", 1, 1, 2, 25, 0, 0, 0, 0, 0, 0),
    SCAVENGER_2("scavenger", 2, 2, 3, 45, 5, 0, 0, 0, 0, 0),
    SCAVENGER_3("scavenger", 3, 3, 3, 60, 5, 1, 0, 0, 0, 0),
    LOOTER_1("looter", 1, 4, 4, 90, 10, 1, 0, 0, 0, 0),
    LOOTER_2("looter", 2, 5, 5, 125, 15, 1, 10, 50, 33, 0),
    LOOTER_3("looter", 3, 6, 5, 150, 20, 2, 10, 75, 33, 0),
    HUNTER_1("hunter", 1, 7, 6, 225, 25, 2, 15, 100, 33, 0),
    HUNTER_2("hunter", 2, 8, 7, 300, 25, 3, 15, 125, 50, 25),
    HUNTER_3("hunter", 3, 9, 8, 400, 30, 4, 20, 175, 50, 25),
    MASTER_1("master", 1, 10, 9, 550, 35, 4, 20, 175, 50, 25),
    MASTER_2("master", 2, 11, 10, 700, 35, 4, 25, 200, 60, 35),
    MASTER_3("master", 3, 12, 11, 950, 40, 5, 25, 200, 60, 35),
    CHAMPION_1("champion", 1, 13, 12, 1250, 40, 5, 30, 250, 60, 40),
    CHAMPION_2("champion", 2, 14, 13, 1600, 45, 6, 30, 275, 65, 45),
    CHAMPION_3("champion", 3, 15, 14, 2000, 45, 6, 35, 300, 70, 45),
    LEGEND("legend", 0, 16, 15, 2500, 50, 7, 40, 350, 75, 50);

    private final String band;
    private final int tierInBand;
    ...
    GreedMedallionTier(String band, int tierInBand, int rankIndex, int baseGreedCoins,
    ...
    public String getPathName() {
        return this.tierInBand > 0 ? this.band + "_" + this.tierInBand : this.band;
    }
