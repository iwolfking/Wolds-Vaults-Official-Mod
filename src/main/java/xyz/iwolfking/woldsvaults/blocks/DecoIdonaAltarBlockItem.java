...
public class DecoIdonaAltarBlockItem extends BlockItem {

    public DecoIdonaAltarBlockItem() {
        super(ModBlocks.DECO_IDONA_ALTAR_BLOCK, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP));
    }

    public static ItemStack fromType(VaultGod god) {
        ItemStack stack = new ItemStack(ModBlocks.DECO_IDONA_ALTAR_BLOCK);
