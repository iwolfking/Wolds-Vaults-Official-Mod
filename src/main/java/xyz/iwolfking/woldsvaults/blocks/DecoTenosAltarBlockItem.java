...
public class DecoTenosAltarBlockItem extends BlockItem {

    public DecoTenosAltarBlockItem() {
        super(ModBlocks.DECO_TENOS_ALTAR_BLOCK, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP));
    }

    public static ItemStack fromType(VaultGod god) {
        ItemStack stack = new ItemStack(ModBlocks.DECO_TENOS_ALTAR_BLOCK);
