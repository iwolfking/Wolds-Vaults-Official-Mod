...
public class DecoWendarrAltarBlockItem extends BlockItem {

    public DecoWendarrAltarBlockItem() {
        super(ModBlocks.DECO_WENDARR_ALTAR_BLOCK, new Item.Properties().tab(ModItems.VAULT_MOD_GROUP));
    }

    public static ItemStack fromType(VaultGod god) {
        ItemStack stack = new ItemStack(ModBlocks.DECO_WENDARR_ALTAR_BLOCK);
