...
public class UnusualModifierLib {
    ...
    static {
        ...
        EFFECT_DURATION.addAll(GearModifierRegistryHelper.createTiers(List.of(0, 25, 50, 75, 85, 95), List.of(25, 50, 75, -1, -1), List.of(0.03F, 0.06F, 0.09F, 0.12F, 0.15F, 0.18F), List.of(0.05F, 0.08F, 0.11F, 0.14F, 0.17F, 0.2F), 0.01F, 10));
